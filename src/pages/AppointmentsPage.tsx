  ...
  const handleUpdateStatus = (id: string, newStatus: Appointment['status']) => {
    ...
    setAppointments(prev => prev.map(apt => {
      if (apt.id === id) {
        ...
        else if (newStatus === 'Consulting') desc = 'Active medical consultation with Dr. Adithi initiated.';
      ...
      timeline: [
        {
          status: 'Scheduled',
          timestamp: 'Just now',
          description: `Follow-up appointment generated by Dr. Adithi following visit ${selectedAppointment.id}.`
        }
      ]
    };
